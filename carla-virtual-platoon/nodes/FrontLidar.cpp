...
FrontLidarPublisher::FrontLidarPublisher(boost::shared_ptr<carla::client::Actor> actor)
    ...
    lidar_sensor_tick = sanitize_numeric_attr(lidar_sensor_tick);
    lidar_rotation_frequency = sanitize_numeric_attr(lidar_rotation_frequency);
    lidar_horizontal_fov = sanitize_numeric_attr(lidar_horizontal_fov);
    lidar_upper_fov = sanitize_numeric_attr(lidar_upper_fov);
    lidar_lower_fov = sanitize_numeric_attr(lidar_lower_fov);
    lidar_range = sanitize_numeric_attr(lidar_range);
